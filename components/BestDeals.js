        ...
        {products.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {products.map((product) => {
              console.log('Deal Product ID:', product._id, 'Type:', typeof product._id);
              return (
                <Link
                  key={product._id}
                ...
                >
                  ...
                  >
                    ...
                    <button className="absolute bottom-3 right-3 p-2 bg-white rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10">
